...
public class JCFChannelService implements ChannelService {
    ...
    public Long createChannel(ChannelReqDTO channelReqDTO) {
        ...
        // 생성
        try {
            Channel channel = new Channel(channelReqDTO);
    ...
    public ChannelResDTO getChannel(Long id) {
        ...
        return new ChannelResDTO(id, channel);
    }
    ...
    public ChannelResDTO getChannel(String uuid) {
        ...
        return new ChannelResDTO(channel.get().getKey(), channel.get().getValue());
    }
    ...
    public List<ChannelResDTO> getAllChannel() {
        return channelData.entrySet().stream()
                .map(entry ->
                        new ChannelResDTO(entry.getKey(), entry.getValue()))
