...
public enum ErrorCode {
  ...
  FAILED_TO_CREATE_PRESIGNED_URL(HttpStatus.INTERNAL_SERVER_ERROR, "STORAGE006",
  ...
  MISSING_OR_INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH004", "리프레시 토큰이 없거나 유효하지 않습니다."),
  REFRESH_TOKEN_SESSION_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH005",
      "리프레시 토큰에 대한 유효한 세션이 존재하지 않습니다."),
