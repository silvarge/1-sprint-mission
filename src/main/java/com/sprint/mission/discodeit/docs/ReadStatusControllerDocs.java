...
public interface ReadStatusControllerDocs {
    ...
    CustomApiResponse<ReadStatusResponseDto> createReadStatus(@RequestBody ReadStatusRequestDto readStatusReqDto);
    ...
    CustomApiResponse<ReadStatusResponseDto> updateReadStatus(
    ...
    CustomApiResponse<List<ReadStatusResponseDto>> getReadStatusByUser(@Parameter(description = "유저 ID", required = true) @RequestParam UUID userId);
}
