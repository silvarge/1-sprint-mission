...
class MessageRepositoryTest {
  ...
  void findMessagesFirstPage() {
    ...
    // when
    Slice<Message> messages = messageRepository.findMessagesFirstPage(publicChannel.getId(),
        pageable);
  ...
  void findMessagesFirstPageFailedCauseEmptyMessage() {
    ...
    // when
    Slice<Message> messages = messageRepository.findMessagesFirstPage(privateChannel.getId(),
        pageable);
